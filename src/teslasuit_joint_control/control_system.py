...
class SkeletalModel():
    ...
    def __init__(self) -> None:
        ...
        #     None,
        #     None,
        #     TsBone2dIndex.LeftUpperLeg,
        #     TsBone2dIndex.LeftLowerLeg)
        # self.right_knee_joint = Joint(
        #     'Right',
        #     BiomechanicalAngle(
        #         'Knee',
        #         'Saggital',
        ...
        #     None,
        #     None,
        #     TsBone2dIndex.RightUpperLeg,
        #     TsBone2dIndex.RightLowerLeg)
        # # ankle
        # self.left_ankle_joint = Joint(
        #     'Left',
        #     BiomechanicalAngle(
        #         'Ankle',
        #         'Saggital',
        ...
        #     None,
        #     TsBone2dIndex.LeftLowerLeg,
        #     TsBone2dIndex.LeftFoot)
        # self.right_ankle_joint = Joint(
        #     'Right',
        #     BiomechanicalAngle(
        #         'Anklee',
        #         'Saggital',
